...
int main(){
    ...
    string filename;
    string arr[20] = {"100_5_","100_10_","100_20_","100_50_","100_70_","500_5_","500_10_","500_20_","500_50_","500_70_","500_100_","500_150_","1000_5_","1000_10_","1000_20_","1000_50_","1000_70_","3000_5_","3000_10_","3000_20_"};
    ...
    for ( int index = 0; index < 20; ++index){
        for (int suffix = 0; suffix < 100; ++suffix){
            filename = arr[index] + to_string(suffix);
